...
var sessionChecker=(req,res,next)=>{
    ...
    }  //is there any session created for user ? and is there any cookie created at server sie for that user
    else{
        next()
    }
}
    ...
    try{
        ...
        if(!user){
            ...
            user.comparePassword(password,(error,match)=>{
                if(!match){
                    res.send("User exists but password doesn't matched");
